...
{
    /// <summary>
    /// Provides power setting GUID to alias mapping
    /// </summary>
    public static class PowerSettingAliases
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the known power settings dictionary
        /// </summary>
        public static IReadOnlyDictionary<Guid, string> KnownPowerSettings => _knownPowerSettings;
        ...
        {
            if (_knownPowerSettings.TryGetValue(settingGuid, out string alias))
            {
                return alias;
            }
        ...
        public static Guid GetPowerSettingGuid(string settingAlias)
        {
            try
            {
                var match = _knownPowerSettings
                    .FirstOrDefault(kvp => kvp.Value.Equals(settingAlias, StringComparison.OrdinalIgnoreCase));
